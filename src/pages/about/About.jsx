    ...
    <div className="aboutMain">
      ...
      <div className="aboutContainer">
        <div className="aboutPresentation">
          ...
          <p className="aboutTextPrensetation">Si vous souhaitez devenir maître de votre vie au lieu de la subir, prennez contact avez nous <Link to="/contact">ICI</Link>.</p>
        </div>
